...
@section('title', 'Mata Pelajaran — Admin TutorKu')
...
<div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:20px;gap:12px;flex-wrap:wrap;">
    <div>
        <h1 style="font-size:16px;font-weight:600;margin:0 0 2px;color:#1a1a2e">Mata Pelajaran</h1>
        <p style="font-size:13px;color:#8890a8;margin:0">Kelola daftar mata pelajaran yang tersedia di platform.</p>
    </div>
    <button type="button"
            class="tk-topbar-btn"
                ...
                @empty
                    <tr id="emptyRow">
                        <td colspan="6" style="padding:52px 0;text-align:center;color:#8890a8">
                            ...
                            <p style="font-size:13px;margin:0">Belum ada mata pelajaran.<br>
                                <span style="color:#b0b8cc">Klik "Tambah Mata Pelajaran" untuk memulai.</span>
                            </p>
                        </td>
                    </tr>
                @endforelse
            ...
            <div class="modal-body" style="padding:20px 24px">
                ...
                <div style="margin-bottom:16px">
                    <label style="font-size:12px;font-weight:500;color:#4b5574;margin-bottom:6px;display:block"
                           for="mapelNama">
                        Nama Mata Pelajaran <span style="color:#991b1b">*</span>
                    </label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('searchMapel').addEventListener('input', function () {
        ...
        document.getElementById('countLabel').textContent = visible + ' mata pelajaran';
    });
    ...
    document.addEventListener('click', function (e) {
        ...
        document.getElementById('mapelModalTitle').innerHTML = '<i class="bi bi-pencil" style="color:#1e2d6b"></i> Edit Mata Pelajaran';
        mapelModal.show();
    });
