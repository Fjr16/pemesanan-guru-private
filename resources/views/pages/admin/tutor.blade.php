...
<div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:20px;gap:12px;flex-wrap:wrap;">
    <div>
        ...
        <p style="font-size:13px;color:#8890a8;margin:0">Kelola daftar tutor yang tersedia di platform.</p>
    </div>
    <button type="button"
            class="tk-topbar-btn"
            ...
            id="btnTambahMapel">
        <i class="bi bi-plus-lg"></i> Tambah Tutor
    </button>
</div>
                ...
                @empty
                    <tr id="emptyRow">
                        <td colspan="6" style="padding:52px 0;text-align:center;color:#8890a8">
                            ...
                            <p style="font-size:13px;margin:0">Belum ada Tutor.<br>
                                <span style="color:#b0b8cc">Klik "Tambah Tutor" untuk memulai.</span>
                            </p>
                        </td>
                    </tr>
                @endforelse
            ...
            <div class="modal-body" style="padding:20px 24px">
                ...
                <div style="margin-bottom:16px">
                    <label style="font-size:12px;font-weight:500;color:#4b5574;margin-bottom:6px;display:block"
                           for="mapelNama">
                        Nama Tutor <span style="color:#991b1b">*</span>
                    </label>
                ...
                <div style="margin-bottom:16px">
                    ...
                    <textarea id="mapelDeskripsi" rows="2"
                              placeholder="Deskripsi singkat Tutor ini..."
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('btnTambahMapel').addEventListener('click', function () {
        ...
        document.getElementById('mapelModalTitle').innerHTML = '<i class="bi bi-plus-circle" style="color:#1e2d6b"></i> Tambah Tutor';
        mapelModal.show();
    });
    ...
    document.addEventListener('click', function (e) {
        ...
        document.getElementById('mapelModalTitle').innerHTML = '<i class="bi bi-pencil" style="color:#1e2d6b"></i> Edit Tutor';
        mapelModal.show();
    });
    ...
    document.getElementById('btnSaveMapel').addEventListener('click', function () {
        ...
        .then(({ ok, data }) => {
            if (!ok) throw data;
            mapelModal.hide();
            showToast(method === 'POST' ? 'Tutor berhasil ditambahkan.' : 'Tutor berhasil diperbarui.');
    ...
    document.addEventListener('change', function (e) {
        ...
        .then(() => showToast(isActive ? 'Tutor diaktifkan.' : 'Tutor dinonaktifkan.'))
        .catch(() => {
    ...
    document.addEventListener('click', function (e) {
        ...
        document.getElementById('deleteMapelWarning').textContent = count > 0
            ? `⚠ Ada ${count} tutor yang mengajar Tutor ini. Relasi akan dilepas.`
            : '';
        deleteModal.show();
    });
